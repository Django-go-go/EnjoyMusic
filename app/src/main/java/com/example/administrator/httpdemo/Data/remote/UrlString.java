...
//        }
    ...
    public static class Billboard {
        ...
        //http://tingapi.ting.baidu.com/v1/restserver/ting?from=android&version=5.6.5.6&format=json&method=baidu.ting.billboard.billCategory&&kflag=1
         ...
         * @return
         */
        //http://tingapi.ting.baidu.com/v1/restserver/ting?from=android&version=5.6.5.6&format=json&method=baidu.ting.billboard.billList&&&type=1&offset=0&size=&fields=song_id,title,author,album_title,pic_big,pic_small,havehigh,all_rate,charge,has_mv_mobile,learn,song_source,korean_bb_song
    ...
    //http://tingapi.ting.baidu.com/v1/restserver/ting?from=android&version=5.6.5.6&format=json&method=baidu.ting.diy.gedanCategory
    public static class GeDan {
         ...
         * @return
         */
        //http://tingapi.ting.baidu.com/v1/restserver/ting?from=android&version=5.6.5.6&format=json&method=baidu.ting.diy.getHotGeDanAndOfficial&num=2
         ...
         * @return
         */
        //http://tingapi.ting.baidu.com/v1/restserver/ting?from=android&version=5.6.5.6&format=json&method=baidu.ting.diy.gedan&page_size=10&page_no=1
         ...
         * @return
         */
        //http://tingapi.ting.baidu.com/v1/restserver/ting?from=android&version=5.6.5.6&format=json&method=baidu.ting.diy.search&page_size=10&page_no=1&query=华语
         ...
         * @return
         */
        //http://tingapi.ting.baidu.com/v1/restserver/ting?from=android&version=5.6.5.6&format=json&method=baidu.ting.diy.gedanInfo&listid=
